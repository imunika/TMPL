        ...
        <div className="my-10 md:col-span-4 col-span-6 bg-[rgba(190,58,59,0.03)]">
          ...
          <div className="px-5 pb-10 sm:mx-10 xl:mx-20 2xl:mx-28">                
            ...
            <div className="flex items-center">
              <div><img src="/images/headshots/danielle_smith.png" className="p-2 mx-auto w-16 h-16" alt="" /></div>
              <div>by <a href="/contributors/danielle_smith" className="text-black font-black hover:text-[#be3a3b] hover:no-underline hover:font-black">Danielle Taana Smith</a></div>
            </div>
            <div className="text-md text-slate-700 font-light leading-7">
              ...
              <div>
                ...
                <div  className="flex flex-col justify-center items-center">
                  <img src="/images/works/teaching-arts-resistance-curriculum-of-love/fig1.jpg" alt="" />
                ...
                <br />
                <div  className="flex flex-col justify-center items-center">
                  <img src="/images/works/teaching-arts-resistance-curriculum-of-love/fig2.jpg" alt="" />
                    <figcaption className="mt-3 ml-1 text-xs text-slate-600 dark:text-gray-400">
                ...
                <br />
                <div  className="flex flex-col justify-center items-center">
                  <img src="/images/works/teaching-arts-resistance-curriculum-of-love/fig3.jpg" alt="" />
                    <figcaption className="mt-3 ml-1 text-xs text-slate-600 dark:text-gray-400">
                ...
                <br />
                <div  className="flex flex-col justify-center items-center">
                  <img src="/images/works/teaching-arts-resistance-curriculum-of-love/fig4.jpg" alt="" className="w-[70%]"/>
                    <figcaption className="mt-3 ml-1 text-xs text-slate-600 dark:text-gray-400">
