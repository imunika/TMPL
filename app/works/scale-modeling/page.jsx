        ...
        <div className="my-10 md:col-span-4 col-span-6 bg-[rgba(190,58,59,0.03)]">
          ...
          <div className="px-5 pb-10 sm:mx-10 xl:mx-20 2xl:mx-28">                
            ...
            <div className="flex items-center">
              <div><img src={`${basePath}/images/headshots/mike_goode.png`} className="p-2 mx-auto w-16 h-16" alt="" /></div>
              <div>by <Link href="/contributors/mike_goode" className="text-black font-black hover:text-[#be3a3b] hover:no-underline hover:font-black">Mike Goode</Link></div>
            </div>
            <div className="text-md text-slate-700 font-light leading-7">
              ...
              <div>
                ...
                <div  className="flex flex-col justify-center items-center">
                  <img src={`${basePath}/images/works/scale-modeling/fig1.jpg`} alt="" className="w-[70%]" />
                ...
                <blockquote className="relative border-s-4 border-[#f0d2d2] ps-4 sm:ps-6 dark:border-gray-700">
                  <p className="text-gray-800 sm:text-base dark:text-white"><em>
                ...
                <br />
                <div  className="flex flex-col justify-center items-center">
                  <img src={`${basePath}/images/works/scale-modeling/fig3.jpg`} alt="" />
                    <figcaption className="mt-3 ml-1 text-xs text-slate-600 dark:text-gray-400">
