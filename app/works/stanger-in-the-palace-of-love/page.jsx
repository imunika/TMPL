        ...
        <div className="my-10 md:col-span-4 col-span-6 bg-[rgba(190,58,59,0.03)]">
          ...
          <div className="px-5 pb-10 sm:mx-10 xl:mx-20 2xl:mx-28">                
            ...
            <div className="flex items-center">
              <div><img src={`${basePath}/images/headshots/lawrence_chua.png`} className="p-2 mx-auto w-16 h-16" alt="" /></div>
              <div>by <Link href="/contributors/lawrence_chua" className="text-black font-black hover:text-[#be3a3b] hover:no-underline hover:font-black">Lawrence Chua</Link></div>
            </div>
            <div className="text-md text-slate-700 font-light leading-7">
              <div className="mt-6 border-t border-[#d3d3d3]">
              </div>
              <div>
                <blockquote class="relative text-center max-w-lg mx-auto mt-6 pt-8">
                  <div class="relative z-10">
                    <p class="text-xl text-gray-800">
                      <em class="relative">
                        <svg class="absolute -top-8 -start-8 h-16 w-16 text-gray-100 sm:h-24 sm:w-24 dark:text-gray-700" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <span class="text-lg relative z-10 dark:text-white">Today I believe in the possibility of love; that is why I endeavor to trace its imperfections, its perversions.—Frantz Fanon<sup><Link href="#fn1" id="ref1" class="anchor">1</Link></sup></span>
                      </em>
                    </p>
                  </div>
                </blockquote>
                <p  className="mt-4 pt-8 
                  ...
                  Both cenotaph and tomb, the Taj Mahal operates as both a monument to love and a monument to death. But its history as a romantic site is of more recent provenance than its history as a monument to temporality.<sup><Link href="#fn2" id="ref2" class="anchor">2</Link></sup>  Its formalist geometry and symmetry as well as its gleaming marble cladding create a stunning visual effect, the contradictory appearance of both solidity and lightness, a hulking volume with the detailing of a precious gemstone. They also placed the 17<sup>th</sup>-century Taj within a standard of beauty that emerged in the 18<sup>th</sup> century that falsely associated whiteness with the beauty of an earlier classical period.<sup><Link href="#fn3" id="ref3" class="anchor">3</Link></sup>  Built in the early modern period, the Taj was constructed at a moment in which the world-making practices of the medieval and classical worlds were giving way to a new mode of building and a new way of thinking. Hannah Arendt used the term “world-making” in the mid-20<sup>th</sup> century to refer to the project of philosophy as a social project.<sup><Link href="#fn4" id="ref4" class="anchor">4</Link></sup>  More recently, scholars like Ariella Aïsha Azoulay have deployed the term to reframe an understanding of precolonial creative practices as living social practices and not as commodity-oriented “art.”<sup><Link href="#fn5" id="ref5" class="anchor">5</Link></sup>  This difference between “art” and “worldmaking” is echoed&mdash;albeit in an essentialist way&mdash;on the first page of one of the early 20<sup>th</sup>-century guidebooks that the curator of Banerjee’s exhibition at the SU Art Museum, Romita Ray, placed across from the sculpture, almost as a conversation partner (fig. 1):</p>
                <br />
                <blockquote className="relative border-s-4 border-[#f0d2d2] ps-4 sm:ps-6 dark:border-gray-700">
                  <p className="text-gray-800 sm:text-base dark:text-white">
                  “India is the only part of the British Empire where art is still a living reality, a portion of the people’s spiritual possessions. We, in our ignorance and affectation of superiority, make efforts to improve it with Western ideas; but, so far, have only succeeded in doing it incalculable harm. It would be wiser if we would first attempt to understand it.”<sup><Link href="#fn6" id="ref6" class="anchor">6</Link></sup>
                  </p>
                </blockquote>
                <br />
                <div  className="flex flex-col justify-center items-center">
                  <img src={`${basePath}/images/works/stanger-in-the-palace-of-love/fig1.jpg`} alt="" />
                ...
                <br />
                <p className="indent-16">The modern architectural profession emerged within both the colonial project that transformed living social practices into an economy of things and the early modern revolution in European thinking that historians would later call “the Enlightenment.” At the conceptual center of the modern architectural discipline’s new understanding of building was the individual, usually a man, usually white, inscribed arms akimbo within the sacred geometries of the circle and the square.</p>
                <br />
                <p className="indent-16">At the center of Rina Banerjee’s <i>Take me, take me, take me … to the Palace of Love</i> (2003) is an antique globe, a model of the world European empires sought to dominate (fig. 2). It is a model based in scientific reason, but organized according to the new, conceptual order of Westphalian nation-states with clearly defined borders and territories. Hovering precariously above the globe is a heavy antique Anglo-Indian chair (fig. 3). Red orbs cascade over this hybrid throne, filling its seat and spilling over it like luscious jewels or drops of blood. Over all of this, pink plastic sheets, stretched across a metal frame, mimic the spectral form of the Taj Mahal. In its mimicry of the original, Banjeree’s sculpture allows us to peer through the building’s romantic image and glimpse something else.</p>
                <br />
                <br />
                <div  className="flex flex-col justify-center items-center">
                  <img src={`${basePath}/images/works/stanger-in-the-palace-of-love/fig2.jpg`} alt="" />
                    <figcaption className="mt-3 ml-1 text-xs text-slate-600 dark:text-gray-400">
                ...
                <br />
                <div  className="flex flex-col justify-center items-center">
                  <img src={`${basePath}/images/works/stanger-in-the-palace-of-love/fig3.jpg`} alt="" />
                    <figcaption className="mt-3 ml-1 text-xs text-slate-600 dark:text-gray-400">
                ...
                <br />
                <p className="indent-16">The Taj Mahal that we see today is the product of not only an early modern construction project, but its modern defacement and renovation (fig. 4). Throughout the 19<sup>th</sup> century, almost immediately after British troops conquered Agra from the Marathas in 1803, they set about systematically looting and even auctioning off many important palaces and monuments in the city, including a rumored attempt to dismantle and sell off the Taj Mahal.<sup><Link href="#fn7" id="ref7" class="anchor">7</Link></sup>  Today, we understand these actions as part of the larger colonial project of extracting resources from and impoverishing one of the richest regions in the early modern world. At the end of this century of plunder, George Curzon, who served as Viceroy of India from 1899 to 1905, oversaw the renovation of the Taj Mahal. The representative of Queen Victoria as empress of Britain’s South and some of its Southeast Asian colonies, Curzon was invested in using historical markers and new monuments to establish a colonial narrative about the British empire’s permanence in India during the early 20<sup>th</sup> century.<sup><Link href="#fn8" id="ref8" class="anchor">8</Link></sup>  Curzon took historical liberties in his renovation of the Taj Mahal and introduced several ahistorical motifs (including replacing the chandeliers looted by the Jats with Egyptian lamps) and redesigning the gardens to conform to English landscape standards, removing many of the fruit trees that had grown to maturity and began to overshadow the tomb itself. Curzon’s renovations staged the tomb as an object within a manicured lawn and secured its place as a romantic site. Writing to his friend, St. John Brodrick, Curzon openly described his own romantic inclinations:</p>
                <br />
                <blockquote className="relative border-s-4 border-[#f0d2d2] ps-4 sm:ps-6 dark:border-gray-700">
                  <p className="text-gray-800 sm:text-base dark:text-white">
                  “The Taj is incomparable, designed like a palace and finished like a jewel—a snow-white emanation starting from a bed of cypresses and backed by a turquoise sky, pure, perfect and unutterably lovely. One feels the same sensation as in gazing at a beautiful woman, one who has that mixture of loveliness and sadness which is essential to the highest beauty.”<sup><Link href="#fn9" id="ref9" class="anchor">9</Link></sup>
                  </p>
                </blockquote>
                <br />
                <div  className="flex flex-col justify-center items-center">
                  <img src={`${basePath}/images/works/stanger-in-the-palace-of-love/fig4.jpg`} alt="" />
                    <figcaption className="mt-3 ml-1 text-xs text-slate-600 dark:text-gray-400">
                ...
                <br />
                <p className="indent-16">Curzon’s comments illuminate the ways that desire, or more specifically the inability of powerful white men and women to control their desires, drove empire and its ideologies. This act of hubris extended not only to the lands, resources, and peoples they exerted power over but to the concepts of time and space that they sought to subjugate to the progressive clock- and calendar-time of modernity and the bordered geography of nation-states.<sup><Link href="#fn10" id="ref10" class="anchor">10</Link></sup>  Just as world-making practices that produced sites like the Taj Mahal could be reduced to object-making processes that reduced life to things, within this new spatio-temporal conception, an idea like “love” could be reshaped with new romantic meanings that centered on the individual.</p>
                <br />
                <p className="indent-16">But the Taj Mahal glimmers with sacred verses and not the unrequited yearnings of romantic poetry. Over the four doors of the tomb are inscribed <i>suras</i> that foretell the terrible events that will occur on the Day of Judgement: the folding up, the cleaving asunder, the rendering asunder of our world. They end on the east door with <i>Al-Baiyina</i>, “the Clear Evidence,” a reminder that those who are righteous and do good works shall dwell forever in Gardens of Paradise beneath which rivers flow.<sup><Link href="#fn11" id="ref11" class="anchor">11</Link></sup>  These are not the melancholic sentiments of “loveliness and sadness” that Curzon hallucinated. Rather, these are sentiments that connect the reader to times, places, and lives beyond the individual. They challenge us to conceive of a world that emerges out of a different kind of love, one that is not in bondage to the individual or a pathological attachment to a lost object of desire, but that obligates us to act selflessly on each other’s behalf and to transcend the poverty of the self. It is the love that Fanon calls us to study in <i>Black Skin, White Masks</i>: a love liberated from the coloniality of power and what he called “the metaphysis of race,” a love deeply rooted in collective practice.</p>
                <br />
                <p className="indent-16">The objects in <i>Take me, take me, take me…to the Palace of Love</i> come from different parts of the colonized world, a third world that still fabricates the luxury objects and daily conveniences of the first world. They were plucked out of circulation by Banerjee and placed in this new context where they tell a story about a shared experience of surviving the brutality of empire. Embraced by an ephemeral shelter of pink plastic and metal scaffolding, their ontological values are no longer determined by a marketplace of commodities. It is in these queer shadows that Banerjee gives them the opportunity to conjure new worlds beyond the world in flames colonialism has bequeathed us.</p>
                <br />
                <br />
