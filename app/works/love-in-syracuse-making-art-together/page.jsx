          ...
          <div className="px-5 pb-10 sm:mx-10 xl:mx-20 2xl:mx-28">                
            ...
            <div className="text-md text-slate-700 font-light leading-7">
              ...
              <div>
                ...
                <br />
                <p className="indent-16">“You need a community to have value connected to art,” artist and sculptor Rina Banerjee said. “People decide whether they are attracted to an object or if an object is art and so it's really important that you have a community to establish that vocabulary and language.”</p>
                <br />
                <p className="indent-16">Banerjee's paintings and installations featured in <i>Take Me to the Palace of Love</i> (Syracuse University Art Museum, 2023) are rooted in this sentiment. She believes that making art collaboratively is the best way to form relationships and engage in individual storytelling.</p>
                <br />
                ...
                <br />
                <p className="indent-16">Banerjee said the idea of a public art making project originated from creating her site-specific installation <i>A World Lost</i> at Sackler Gallery in 2013. In addition to troublesome lighting, the metal ribs of the installation’s dome were overwhelmed by the black stone in the walls, ceiling, and floor of the space that held the sculpture — an obstacle the artist said she hadn’t anticipated. So, Banerjee recruited gallery staff to assist her in covering the sculpture’s metal ribs with threaded marine rope, which she said added a frilly look to the piece.</p>
                <br />
                <p className="indent-16">Several staff members gathered at tables and threaded ropes with red thread. The activity naturally sparked conversations about Banerjee’s installation, life stories, and experiences working at Sackler Gallery. “It also reminded me of my initiative for bringing this kind of slow, meticulous, detail-oriented work that I learned to love because it's really relaxing and it allows people to share,” Banerjee said.</p>
                <p className="indent-16">Growing up, Banerjee said her mother taught her and her sisters how to sew, crochet, and knit — skills that she’s since embodied within many of her works. The artist said she finds it interesting that since working with thread doesn’t require much muscle, that needleworking is deemed feminine.</p>
                <br />
                <p className="indent-16">“There’s more to just the act of putting the needle to the rope,” Banerjee said. “There’s a very long history of knotting that is part of all cultures and their histories — everything from surgery to fixing a house, and they are taught separately and all very gendered. And I think it was time for me to think about that.”</p>
                <br />
                <p className="indent-16">Banerjee said the event at Salt City Market was her third time leading a version of the community project. She has led a similar workshop at Brown University.</p>
                <br />
                <p className="indent-16">“It’s really exciting to see the range of ages and different relationships,” Banerjee said of the participants at Salt City Market. “You could really see [determination] on their faces as they worked. I think people enjoy seeing their product as it grows.”</p>
                <br />
                <p className="indent-16">Waithe, one of the project collaborators, said that, as a Black woman, braiding has been part of her life since she was first taught how to style her hair around 10 years old. When braiding someone else’s hair, Waithe said the act prompts conversation. She’s actively bonding with the person whose hair she’s braiding.</p>
                <br />
                <p className="indent-16">“It’s a time for sharing and growing, because when you learn about other people they may inspire me to transcend from wherever I am in the moment,” Waithe said. “If you love what you do you have passion for it. It becomes effortless. That’s how I see a love of braiding.”</p>
                <br />
                <p className="indent-16">Syracuse University student N’dei Innocent, who was raised in New York City by parents who moved to the U.S. from St. Lucia and Haiti, said while participating in the event she recognized the compassion in others who she created with.</p>
                <br />
                <p className="indent-16">“You can find love in very small gestures,” Innocent said. “They cared enough to come up to me and say ‘good morning’ and start a conversation.”</p>
                <br />
                <p className="indent-16">Throughout Banerjee’s residency, past fellows of the Narratio Fellowship storytelling and leadership program engaged with the artwork featured in Banerjee’s exhibition at Syracuse University Art Museum and created profound poems and a documentary film based on the art-making event at Salt City Market. Brice Nordquist, co-founder and co-director of the Narratio Fellowship, said it's only fitting for its fellows to create in conjunction with Banerjee since the program aims to reject the kind of narrative that Western audiences might expect of diasporic communities.</p>
                <br />
                <p className="indent-16">“Banerjee’s work does that really well,” Nordquist said. “It disrupts the expectation of what an Indian-American woman is going to be creating.”</p>
                <br />
                <br />
              </div>
            </div>
